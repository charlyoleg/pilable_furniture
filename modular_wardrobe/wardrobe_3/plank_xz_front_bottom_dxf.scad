...
echo("plank_number:", 1);
//github_openscad -o wardrobe_3/plank_xz_front_bottom.dxf -D wardrobe_n=3 -D cutting_edge=0 -D break_view_length=0 wardrobe_3/plank_xz_front_bottom_dxf.scad
