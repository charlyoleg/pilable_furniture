...
plank_xz_front_bottom(wardrobe_n);
echo("plank_length:", wardrobe_n*module_width);
echo("plank_width:", plank1_width);
echo("plank_thickness:", plank_thickness);
echo("plank_number:", 1);
//github_openscad -o wardrobe_2/plank_xz_front_bottom.dxf -D wardrobe_n=2 -D cutting_edge=0 -D break_view_length=0 wardrobe_2/plank_xz_front_bottom_dxf.scad
