...
echo("plank_number:", 2);
//github_openscad -o wardrobe_1/plank_xy_bottom.dxf -D wardrobe_n=1 -D cutting_edge=0 -D break_view_length=0 wardrobe_1/plank_xy_bottom_dxf.scad
