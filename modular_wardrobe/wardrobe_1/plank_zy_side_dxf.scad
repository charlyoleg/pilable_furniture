...
plank_zy_side();
echo("plank_length:", pzy_side_length);
echo("plank_width:", plank1_width);
echo("plank_thickness:", plank_thickness);
echo("plank_number:", 4);
//github_openscad -o wardrobe_1/plank_zy_side.dxf -D wardrobe_n=1 -D cutting_edge=0 -D break_view_length=0 wardrobe_1/plank_zy_side_dxf.scad
