...
echo("plank_number:", 1);
//github_openscad -o wardrobe_1/plank_xz_front_bottom.dxf -D wardrobe_n=1 -D cutting_edge=0 -D break_view_length=0 wardrobe_1/plank_xz_front_bottom_dxf.scad
